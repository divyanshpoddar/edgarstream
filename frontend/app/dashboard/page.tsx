    ...
    <>
      ...
      <section className="mb-12">
        ...
        <p className="text-muted text-lg max-w-2xl leading-relaxed">
          Real-time SEC EDGAR filings pipeline. Monitors RSS feeds every 30 minutes,
          ...
          {[
            {
              ...
              desc: "Monitors the SEC EDGAR real-time feed every 30 minutes across all form types. Deduplicates via Redis seen-set.",
              color: "text-blue",
            },
            {
